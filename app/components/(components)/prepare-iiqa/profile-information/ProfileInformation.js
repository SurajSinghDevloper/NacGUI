  ...
  const handleDocDelete = async (e) => {
    switch (e) {
      ...
      case "file-recognitionByUGC12B-documnet":
        ...
        newObj6.section12b.section12bDocument = "";
        setVariable(newObj6);
        break;
            ...
            <div className="flex justify-end w-full">
              <div id="ugcdoc6" className="w-3/5">
                {variable.autonomous.autonomousDocument ? (
                  (console.log(variable.autonomous.autonomousDocument),
                  (
                    <div className="flex flex-row">
                      <a
                        className="cursor-pointer my-auto ml-2"
              ...
              <div className="w-3/5">
                {variable.cpe.cpeDocument ? (
                  <div className="flex flex-row">
                    <a
                      className="cursor-pointer my-auto ml-2"
                      href={config.RESOURCE_URL + variable.cpe.cpeDocument}
                      target="_blank"
                    >
                      View Document
                    </a>
              ...
              <div className="w-3/5 flex">
                ...
                {variable.aishe.aisheDocument ? (
                  <div className="flex flex-row">
                    <a
                      className="cursor-pointer my-auto ml-2"
                      href={config.RESOURCE_URL + variable.aishe.aisheDocument}
                      target="_blank"
                    >
                      View Document
                    </a>
